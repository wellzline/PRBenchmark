...
class ResNet(nn.Module):
    ...
    """
    def __init__(self, block, input_size, num_blocks, num_classes=10, device='cpu'):
...
def resnet(name, input_size, num_classes=10, pretrained=False, device='cpu'):
    """
    ...
    """
    if name == 'resnet18':
        return ResNet(BasicBlock, input_size, [2, 2, 2, 2], num_classes=num_classes, device=device)
    elif name == 'resnet34':
        return ResNet(BasicBlock, input_size, [3, 4, 6, 3], num_classes=num_classes, device=device)
    elif name == 'resnet50':
